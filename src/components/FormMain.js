    ...
    <>
      <div className="form">
              ...
              >
                <g id="Battery">
                  <path
                    ...
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M2.66667 1H19.0367C19.9572 1 20.7034 1.74619 20.7034 2.66667V9.33333C20.7034 10.2538 19.9572 11 19.0367 11H2.66666C1.74619 11 1 10.2538 1 9.33333V2.66667C1 1.74619 1.74619 1 2.66667 1ZM0 2.66667C0 1.19391 1.19391 0 2.66667 0H19.0367C20.5094 0 21.7034 1.19391 21.7034 2.66667V9.33333C21.7034 10.8061 20.5094 12 19.0367 12H2.66666C1.19391 12 0 10.8061 0 9.33333V2.66667ZM24 6C24 6.9245 23.4838 7.75894 22.6899 8.11765V3.88235C23.4838 4.24106 24 5.07551 24 6Z"
                    fill="#170E2B"
                  />
                  <rect
                    id="Capacity"
          ...
          <Card color="transparent" shadow={false}>
            <form className="form-d">
              <div className="flex flex-col gap-[18px]">
                <div className="full-name-txt">Full Name</div>
                <Input
                  type="text"
                  variant="outlined"
                  className="w-full"
                ...
                <Input
                  ...
                  label="Email"
                />{" "}
                <span className="emailSvg">
                  <img src={EmailSVG} alt="mail" />
                </span>
                <div className="json-file-txt"> Upload JSON File</div>
                <label className="custom-file-upload mt-1">
                  ...
                  />
                  <span>
                    <img src={FileSVG} alt="file" className="file" />
                  </span>
                  <span className="browse-txt">Browse File</span>
                </label>
              </div>
              <div className="file-contents-section">
                <div className="file-contents-txt">File Contents</div>
                ...
                <div className="modal">
                  ...
                  >
                    <DialogBody divider className="dialog">
                      ...
                      <Button className="submit-b">
                        <p className="goto-txt">Go to My Entries</p>
                      </Button>
                      <Button
                        className="cancel-b"
        ...
        <div className="navbar-bottom">
          <Button variant="filled" className="submit-btn" onClick={handleOpen}>
            Submit
          </Button>
        </div>
      </div>
